...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class IdentityServerAuthenticationExtensions
    {
        ...
        public static AuthenticationBuilder AddSelfIdentityServerAuthentication(this AuthenticationBuilder builder, Action<SelfIdentityServerAuthenticationOptions> configureOptions) =>
            builder.AddSelfIdentityServerAuthentication(IdentityServerAuthenticationDefaults.AuthenticationScheme, configureOptions);
        ...
        public static AuthenticationBuilder AddSelfIdentityServerAuthentication(this AuthenticationBuilder builder, string authenticationScheme, Action<SelfIdentityServerAuthenticationOptions> configureOptions)
        {
            builder.AddJwtBearer(authenticationScheme + IdentityServerAuthenticationDefaults.JwtAuthenticationScheme, configureOptions: null);
            builder.AddOAuth2Introspection(authenticationScheme + IdentityServerAuthenticationDefaults.IntrospectionAuthenticationScheme, configureOptions: null);
            ...
            builder.Services.AddSingleton<IConfigureOptions<JwtBearerOptions>>(services =>
            {
                var monitor = services.GetRequiredService<IOptionsMonitor<SelfIdentityServerAuthenticationOptions>>();
                return new ConfigureInternalOptions(monitor.Get(authenticationScheme), authenticationScheme);
            });
            ...
            return builder.AddScheme<SelfIdentityServerAuthenticationOptions, SelfIdentityServerAuthenticationHandler>(authenticationScheme, configureOptions);
        }
